...
else if(isset($_POST['afficheservice']))
{
  ...
  <div style="width:33%;float:left;" class="ui-grid-b">
	<a data-transition="slide" onclick="affiche1('<?php print $row['id_sp']; ?>')" href="#"><div style="min-height:115px;" class="biba"><img style="width:82px;" src="http://villeverteapp.com/villeverte/upload/<?php print $row['photo_sp']; ?>"><br/><span style="font-weight:bold;"><?php print $row['nom_sp']; ?></span></div></a>
