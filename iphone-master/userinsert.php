...
else if(isset($_POST['afficheservice']))
{
    ...
    background-color: white;'>Quelle est votre demande ?</h1>";
    foreach ($bdd->query($sql) as $row) {
	?>

  <div style="width:33%;float:left;" class="ui-grid-b">
	<a data-transition="none" onclick="affiche1('<?php print $row['id_sp']; ?>')" href="#page2"><div style="height:102px;" class="biba"><img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_sp']; ?>"><br/><span style="font-weight:bold;"><?php print $row['nom_sp']; ?></span></div></a>
	...
	<div style="margin:8px auto;float:left;width: 100%;">
						...
						<a data-transition="none" onclick="<!--affiche11('35')-->" href="#nouveautes"><div style="background-color:#ff9f41;" class="promobadg">
	<img class="imgpromobadg" src="promotions.png">
	<div style="width:100%;">
	<div class="texd">Promotions</div></div>
	</div></a>
	
	<a data-transition="none" onclick="<!--affiche11('36')-->" href="#nouveautes">
...
<div style="height:114px;" onclick="addtocart2()" class="biba">
<img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>"><br/><span style="font-size:15px;"><?php print $row['nom_ssp']; ?></span><br/></div>

 <?php }


else if (preg_match("#oui#", $row['final_ssp'])) { ?> <a data-transition="none" href="#page2"> 
...
<img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>"><br/><span style="font-size:15px;"><?php print $row['nom_ssp']; ?></span><br/><?php if ($row['final_ssp'] == 'oui') { ?><span style="color:#f86a3b;font-size:15px;font-weight:bold;"><?php print $row['prixfinal_ssp'].'DH'; ?></span><?php } ?></div>
...
else
{
 ...
 <a onclick="affiche111('<?php print $row['cat_ssp2']; ?>')"  data-transition="none" href="#page222"> 
 
<div style="height:114px;" class="biba">
<img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>"><br/><span style="font-size:15px;"><?php print $row['nom_ssp']; ?></span><br/></div>
</a> 
...
<div onclick="addtocart2()" class="biba">
<img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>"><br/><span style="font-size:15px;"><?php print $row['nom_ssp']; ?></span><br/></div>

<?php }

else if (preg_match("#oui#", $row['final_ssp'])) { ?> <a data-transition="none" href="#page222">
<div onclick="addtocart('<?php print $row['id_ssp']; ?>', 'http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>','<?php print $row['nom_ssp']; ?>','<?php print $row['prixfinal_ssp']; ?>')" class="biba">
<img style="width:100px;" src="http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>"><br/><span style="font-size:15px;"><?php print $row['nom_ssp']; ?></span><br/><?php if ($row['final_ssp'] == 'oui') { ?><span style="color:#f86a3b;font-size:15px;font-weight:bold;"><?php print $row['prixfinal_ssp'].'DH'; ?></span><?php } ?></div>
<div style="display:none;" id="pilo<?php print $row['id_ssp']; ?>"><?php print rtrim($row['descrip_ssp']); ?></div> 
</a> <?php }
...
$id=$_POST['affichesservice1'];
 ...
 <?php   if($row['final_ssp'] !='oui') { ?> <a data-transition="none" href="#page2"> 	<?php } ?>
<div onclick="addtocart('<?php print $row['id_ssp']; ?>', 'http://labseo.net/villeverte/upload/<?php print $row['photo_ssp']; ?>','<?php print $row['nom_ssp']; ?>','<?php print $row['prixfinal_ssp']; ?>','')" class="biba">
<div style="display:none;" id="pilo<?php print $row['id_ssp']; ?>"><?php print rtrim($row['descrip_ssp']); ?></div>
